...
class HomeMenu(ctk.CTkFrame):
    def __init__(self, master, show_specs_cmd, show_optimize_cmd, show_logs_cmd, show_benchmark_cmd, master_app):
        ...
        self.benchmark_btn = ctk.CTkButton(footer, text="BENCHMARK", font=styles.FONT_ORBITRON_SM,
                                           height=75, width=280, command=show_benchmark_cmd)
        styles.apply_tactical_style(self.benchmark_btn)
